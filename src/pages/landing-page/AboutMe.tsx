    ...
    <StyledAboutMe ref={pageRef} id="about-me-scroll">
      ...
      <Content>
        <TopSection>
          ...
          <Description>
            8+ years of experience building SaaS platforms, Automation Systems,
            and AI-powered solutions.
          </Description>
          <Description>
            Cut cloud costs by 30%, automated 2,000+ engineering hours, and
        ...
        <div>
          <Button
            onClick={() =>
              (window as any)
                .open("https://github.com/Takumi-TopDev", "_blank")
                .focus()
            }
          >
            <ButtonContent>
