...
There are a bunch of [open issues](https://github.com/CloudDev777/Personal-Website/issues) that would be great if you could help with.  
Feel free to work on any issue that isn't already assigned to someone.  
Issues that are tagged with [good first issue](https://github.com/CloudDev777/Personal-Website/labels/good%20first%20issue) are the best place to start.
